...
addItem({
  ...
  'section': 'Cabello',
  'img': 'https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcSb0xYCGr5ZKm7ZKHBiwY0RPVzS3XnTwKkTBHTJ_jMExiEmNuiKDVBlPVTD4NDk1FTjoxx5I0Hvgcp9ccHWuZPHvpJBOfJpC4OOnXRYDJdFJKirHONJMqew&usqp=CAE',
  'description': 'Cepillo para barba con cerdas 100% naturales de pelo de jabalí',
  'price': '$199'
});
addItem({
  'name': 'Aceite para barba',
  'section': 'Cabello',
  'img': 'https://sallybeautymx.vtexassets.com/arquivos/ids/181887-1200-1200?v=637496582203270000&width=1200&height=1200&aspect=true',
  'description': 'El aceite de argán para barba dejará tu barba suave y la piel bien hidratada',
  'price': '$126'
});
addItem({
  'name': 'Kit para afeitar para barba',
  'section': 'Cabello',
  'img': 'https://production.na01.natura.com/on/demandware.static/-/Sites-nat-mex-b2b2c-catalog/default/dw56ff8d59/147180.jpg',
  'description': 'Con el kit para afeitar de natura mejora el desliz de la navaja mientras refrescas e hidratas de piel de tu rostro.',
  'price': '$329'
});
